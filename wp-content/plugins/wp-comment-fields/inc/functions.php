...
function wpcomment_make_meta_data( $wpcomment_meta ){
	...
	if( ! isset($wpcomment_meta['wpcomment']['fields']) ) return $wpcomment_meta;
	
	
	$wpcomment_meta			= array();
	$wpcomment_cart_fields	= $wpcomment_meta['wpcomment']['fields'];
...
function wpcomment_is_field_hidden_by_condition( $field_name, $conditionally_hidden=null ) {
	...
	if( !isset($_POST['wpcomment']['conditionally_hidden']) && $conditionally_hidden == null ) return false;
	
	$conditionally_hidden = isset($_POST['wpcomment']['conditionally_hidden']) ? sanitize_text_field($_POST['wpcomment']['conditionally_hidden']) : $conditionally_hidden;
