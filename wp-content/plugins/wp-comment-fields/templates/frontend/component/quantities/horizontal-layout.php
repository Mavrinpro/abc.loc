...
* 
* This template can be overridden by copying it to yourtheme/wpcomment/frontend/component/quantities/horizontal-layout.php
* 
* @version 1.0
**/
...
<div class="nm-horizontal-layout">
    <table class="table table-bordered table-hover wpcomment-style">
       <thead> 
            <tr>
                <th><?php _e('Options', "wpcomment");?></th>
        ...
        <tr>
            <th><?php _e('Quantity', "wpcomment");?></th>
            <?php foreach($options as $opt){ 
