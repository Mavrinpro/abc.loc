...
* 
* This template can be overridden by copying it to yourtheme/wpcomment/frontend/inputs/email.php
* 
* @version 1.0
**/
...
$fm = new WPComment_InputManager($field_meta, 'email');
...
if($onetime == 'on' && $taxable == 'on') {
	...
	$price = wpcomment_get_price_including_tax($price, $product);
}

$input_classes = $fm->input_classes();
if( $price !== '' ) {$input_classes .= ' wpcomment-priced';}
