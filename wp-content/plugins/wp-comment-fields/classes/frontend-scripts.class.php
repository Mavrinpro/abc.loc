		...
		switch ($handle) {
			...
			case 'wpcomment-conditions-v2':
				...
				$localize_data = array(
					...
					'validate_msg'				=> __("is a required field",'wpcomment'),
					'image_max_msg'				=> __("You can only select a maximum of",'wpcomment'),
					'image_min_msg'				=> __("You can only select a minimum of",'wpcomment'),
				);
