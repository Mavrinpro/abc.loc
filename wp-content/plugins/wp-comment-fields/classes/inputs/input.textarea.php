...
class NM_Textarea_WPC extends WPComment_Inputs{
	...
	*/
	...
	function __construct(){
		...
		$this -> icon		= __ ( '<i class="fa fa-file-text-o" aria-hidden="true"></i>', 'wpcomment' );
	...
	private function get_settings(){
		...
		$input_meta = array (
			...
			'rich_editor' => array (
					...
					'link' => __ ( '<a target="_blank" href="https://codex.wordpress.org/Function_Reference/wp_editor">Editor</a>', 'wpcomment' ),
					'col_classes' => array('col-md-3','col-sm-12')
			),
			'desc_tooltip' => array (
					'type' => 'checkbox',
