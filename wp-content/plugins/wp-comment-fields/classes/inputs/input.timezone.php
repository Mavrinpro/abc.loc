...
class NM_Timezone_WPC extends WPComment_Inputs{
	...
	*/
	...
	function __construct(){
		...
		$this -> title 		= __ ( 'Timezone Input', 'wpcomment' );
		$this -> desc		= __ ( 'Show Timezone', 'wpcomment' );
		$this -> icon		= __ ( '<i class="fa fa-clock-o" aria-hidden="true"></i>', 'wpcomment' );
	...
	private function get_settings(){
		...
		$input_meta = array (
				...
				'selected' => array (
						...
						'desc' => __ ( 'Type option name (given above) if you want already selected.', 'wpcomment' ),
						'col_classes' => array('col-md-3','col-sm-12')
				),
				'first_option' => array (
						'type' => 'text',
						'title' => __ ( 'First option', 'wpcomment' ),
						'desc' => __ ( 'Just for info e.g: Select your option.', 'wpcomment' ),
						'col_classes' => array('col-md-3','col-sm-12')
				),
				'regions' => array (
						'type' => 'textarea',
						'title' => __ ( 'Regions', 'wpcomment' ),
				...
				'show_time' => array (
						'type' => 'checkbox',
						'title' => __ ( 'Show Local Time', 'wpcomment' ),
						'desc' => __ ( 'It will show current local time.', 'wpcomment' ),
						'col_classes' => array('col-md-3','col-sm-12')
				),
				'desc_tooltip' => array (
						'type' => 'checkbox',
