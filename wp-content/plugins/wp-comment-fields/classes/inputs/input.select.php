...
class NM_Select_WPC extends WPComment_Inputs{
	...
	*/
	...
	function __construct(){
		...
		$this -> title 		= __ ( 'Select Input', 'wpcomment' );
		$this -> desc		= __ ( 'regular select input', 'wpcomment' );
		$this -> icon		= __ ( '<i class="fa fa-check" aria-hidden="true"></i>', 'wpcomment' );
	...
	private function get_settings(){
		...
		$input_meta = array (
			...
			'options' => array (
					...
					'desc' => __ ( 'Type option with price (optionally), Option ID should be unique and without spaces.', 'wpcomment' )
			),
			'selected' => array (
					'type' => 'text',
