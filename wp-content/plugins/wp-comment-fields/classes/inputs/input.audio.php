...
class NM_Audio_WPC extends WPComment_Inputs{
	...
	*/
	...
	function __construct(){
		...
		$this -> title 		= __ ( 'Audio / Video', "wpcomment" );
		$this -> desc		= __ ( 'Audio File Selection', "wpcomment" );
		$this -> icon		= __ ( '<i class="fa fa-file-video-o" aria-hidden="true"></i>', 'wpcomment' );
	...
	private function get_settings(){
		...
		$input_meta = array (
			...
			'audio' => array (
					'type' => 'pre-audios',
					'title' => __ ( 'Select Audio/Video', "wpcomment" ),
					'desc' => __ ( 'Select audio or video from media library', "wpcomment" ),
					'col_classes' => array('col-md-3','col-sm-12')
			),
			'desc_tooltip' => array (
					'type' => 'checkbox',
			...
			'multiple_allowed' => array (
					'type' => 'checkbox',
					'title' => __ ( 'Multiple selection?', "wpcomment" ),
					'desc' => __ ( 'Allow users to select more then one videos or audios?.', "wpcomment" ),
					'col_classes' => array('col-md-3','col-sm-12')
			),
			'logic' => array (
					'type' => 'checkbox',
