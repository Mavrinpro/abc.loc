...
class WPComment_InputManager {
    ...
    function title() {
        ...
        $title = wpcomment_wpml_translate($title, 'wpcomment');
    ...
    function desc() {
        ...
        $desc = wpcomment_wpml_translate($desc, 'wpcomment');
    ...
    function placeholder() {
        ...
        $placeholder = wpcomment_wpml_translate($placeholder, 'wpcomment');
    ...
    function error_msg() {
        ...
        $error_msg = wpcomment_wpml_translate($error_msg, 'wpcomment');
