 ...
 class WPComment_Fields_Meta {
    ...
    */ 
    function load_script($hook) {
        ...
        // Bootstrap Files
        wp_enqueue_style('wpcomment-bs', WPCOMMENT_URL."/css/bootstrap/bootstrap.css");
            ...
            $html .= '<div class="wpcomment-modal-box wpcomment-slider wpcomment-field-'.esc_attr($fields_type).'">';
			    ...
			    $html .= '<footer>';
			    	$html .= '<span class="wpcomment-req-field-id"></span>';
                   	$html .= '<button type="button" class="btn btn-default wpcomment-close-checker wpcomment-close-fields wpcomment-js-modal-close" style="margin-right: 5px;">'.esc_html__( 'close', 'wpcomment' ).'</button>';
                    $html .= '<button type="button" class="btn btn-primary wpcomment-field-checker wpcomment-add-field" data-field-type="'.esc_attr($field_title).'">'.esc_html__( 'Add Field', 'wpcomment' ).'</button>';
			    $html .= '</footer>';
			$html .= '</div>';
        }
					...
					$html_input	= '<div class="row wpcomment-condition-style-wrap">';
						$html_input	.= '<div class="col-md-3 col-sm-3">';
							$html_input	.= '<select name="wpcomment['.esc_attr($field_index).'][conditions][visibility]" class="form-control wpcomment-condition-visible-bound" data-metatype="visibility">';
								$html_input .= '<option '.$visibility_show.' value="Show">'.__( 'Show', 'wpcomment' ).'</option>';
								$html_input .= '<option '.$visibility_hide.' value="Hide">'.__( 'Hide', 'wpcomment' ).'</option>';
							$html_input	.= '</select>';
						$html_input .= '</div>';

						$html_input	.= '<div class="col-md-2 col-sm-2">';
							$html_input .= '<p>'.__( 'only if', 'wpcomment' ).'</p>';
						$html_input .= '</div>';
						...
						$html_input	.= '<div class="col-md-3 col-sm-3">';
							$html_input	.= '<select name="wpcomment['.esc_attr($field_index).'][conditions][bound]" class="form-control wpcomment-condition-visible-bound" data-metatype="bound">';
								$html_input .= '<option '.$bound_all.' value="All">'.__( 'All', 'wpcomment' ).'</option>';
								$html_input .= '<option '.$bound_any.' value="Any">'.__( 'Any', 'wpcomment' ).'</option>';
							$html_input	.= '</select>';
						$html_input .= '</div>';
    ...
    function wpcomment_fields_tabs($fields_type){
		...
		$tabs = array ( 
				...
				'add_images_tab' => array (
						'label' => __ ( 'Add Images', 'wpcomment' ),
						'class' => array('wpcomment-tabs-label'),
						'field_depend'=> array('image','imageselect')
				),
				'add_audio_video_tab' => array (
						'label' => __ ( 'Add Audio/Video', 'wpcomment' ),
						'class' => array('wpcomment-tabs-label'),
				...
				'fonts_family_tab' => array (
						'label' => __ ( 'Fonts Family', 'wpcomment' ),
						'class' => array('wpcomment-tabs-label'),
						'field_depend'=> array('fonts')
				),
				'custom_fonts_tab' => array (
						'label' => __ ( 'Custom Fonts', 'wpcomment' ),
						'class' => array('wpcomment-tabs-label'),
						'field_depend'=> array('fonts')
				),
				
				'image_dimension_tab' => array (
						'label' => __ ( 'Image Dimensions', 'wpcomment' ),
						'class' => array('wpcomment-tabs-label'),
