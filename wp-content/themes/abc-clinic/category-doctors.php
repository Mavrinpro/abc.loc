                    ...
                    <div class="col-md-6 mb-md-4">
                        <div class="bg_light hover_doc">
                            <div class="row">
                                ...
                                <div class="col-md-6 order-1 order-md-0 mb-5 mb-md-0"><h2
                                            class="fsz_25 f_weight_600 color_cyan2 m-0 mt-3 doc_initial"><?php the_title
                                        (); ?></h2>
    ...
    <section class="mb-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <input type="text" class="input_form mb-3" placeholder="Номер телефона">
...
<path d="M3.69514 9L0 5.14839L1.32941 3.76265L3.69514 6.22854L9.67059 0L11 1.38574L3.69514 9Z" fill="white"/>
 ...
 Я согласен(на) с соглашением на обработку персональных данных</span>
                ...
                <div class="col-md-6">
                    <input type="text" class="input_form mb-3" placeholder="Ваши Ф. И. О.">
                    <span class="fsz-10 color-white mb-2 d-block">
